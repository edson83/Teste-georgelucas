...
public class SwapiApiFromJsoupUsageTest {
    ...
    public void canGetLuke() throws IOException {
        ...
        Assert.assertTrue(json.contains("Geoger Lucas"));
    ...
    /* JSOUP API Exercises
         ...
         - e.g.
mvn install:install-file -Dfile=<caminho\jar-isolado.jar> -DgroupId=<group-id> -DartifactId=<artifact-id> -Dversion=<version> -Dpackaging=jar -DgeneratePom=tru
         ~~~~~~~~
     /Users/edsonshoitishinino/Downloads/jar_files/converter-gson-2.3.0.jar 
/User - -D=<
